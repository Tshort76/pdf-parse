(ns pdf-parse.annotations
  ...
  (:require [clojure.string :as s]
            ...
            [pdf-parse.tokens.pdf-extractor :as ext])
...
(defn obj->color [type class]
  (or (pd-color (component-colors type))
      (pd-color (block-colors class))
      (pd-color (oracle-block-colors class))
      (pd-color (token-colors class))))
